...
\ `v' / __/' _/  / _//__\| |  \| | Author : LuanaMobile
 `. .'| _|`._`. | \_| \/ | | | ' | Telegram : https://t.me/luanamobile
  !_! |___|___/  \__/\__/|_|_|\__| Note : Message send me for support!!
...
def get_invitation(token):
    ...
    try:
        ...
        data = response.json()
        if data['code'] == 0:
            print(f"{Fore.BLUE + Style.BRIGHT} \n -\{Fore.WHITE + Style.BRIGHT} Invited by LuanaMobile {Fore.BLUE + Style.BRIGHT}/-", flush=True)
