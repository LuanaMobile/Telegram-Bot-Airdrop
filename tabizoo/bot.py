        ...
        while True:
            ...
            for no, data in enumerate(data):
                ...
                try:
                    ...
                    # Dönüş
                    if self.auto_spin:
                        base.log(f"{base.yellow}Otomatik Dönüş: {base.green}AÇIK")
                        process_spin(data=data, multiplier=1)
                    else:
                        base.log(f"{base.yellow}Otomatik Dönüş: {base.red}KAPALI")

                    # Yükselt
                    if self.auto_upgrade:
                        base.log(f"{base.yellow}Otomatik Yükseltme: {base.green}AÇIK")
                        process_upgrade(data=data)
                    else:
                        base.log(f"{base.yellow}Otomatik Yükseltme: {base.red}KAPALI")
